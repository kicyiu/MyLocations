...
//  MyLocations
//
//  Created by Alberto Tsang on 12/1/18.
    ...
    var managedObjectContext: NSManagedObjectContext! {
        didSet {
            NotificationCenter.default.addObserver(forName:
                Notification.Name.NSManagedObjectContextObjectsDidChange,object: managedObjectContext, queue: OperationQueue.main) {
                        notification in
...
extension MapViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView,
        ...
        if annotationView == nil {
            ...
            //print("*** creating detail button: \(self)")
